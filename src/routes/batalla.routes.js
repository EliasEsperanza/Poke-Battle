...
import { crearSala, unirseSala, crearBatalla, ataque, obtenerResumen, realizarEnvioAttack, procesarAtaque,terminarBattle, obtenerResultadoTurno } from "../controller/batallaController.js";
...
router.get('/batalla/:batallaId/resultadoTurno', obtenerResultadoTurno);
